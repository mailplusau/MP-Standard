    ...
    function (ui, email, runtime, search, record, http, log, redirect) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                inlineHtml += '<div class="container instruction_div hide" style="background-color: lightblue;font-size: 14px;padding: 15px;border-radius: 10px;border: 1px solid;box-shadow: 0px 1px 26px -10px white;"><p><b><u>Instructions</u></b></br></br><ol><li>Select the desired customer from the "Customer" drop-down menu.</li><li>Choose the specific period or date range you wish to view.</li><li>Click the "Apply Filter" button.</li></ol><b>Monthly Overview:</b></br>The left button above the graph represents the filter for a monthly overview of scanned parcels. Below the graph, you can switch to weekly or daily views to see the total scans for that respective period.</br><b>Customer List:</b></br>The middle left button above the graph provides a list of all customers and their product usage based on the applied filters.</br><b>Source:</b></br>The middle right button above the graph offers data regarding the barcode source (MPEX or Standard).</br><b>Product Weight:</b></br>The right button above the graph gives you information about the products used based on their weight perspective.</p></div></br>'
