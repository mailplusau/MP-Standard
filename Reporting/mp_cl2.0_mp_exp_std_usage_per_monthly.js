    ...
    function (email, runtime, search, record, http, log, error, url, format,
        ...
        function pageInit() {
            ...
            $("#applyFilter").click(function () {
                ...
                var url = baseURL + "/app/site/hosting/scriptlet.nl?script=1712&deploy=1&start_date=" + date_from + '&last_date=' + date_to + '&zee=' + zee + '&custid=' + custid;
        ...
        function loadDebtRecord(date_from, date_to, zee_id) {
            ...
            console.log('debt_set3(Source List): ' + debt_set4)
            console.log('debt_set3(Product Weights): ' + debt_set5)
